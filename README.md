...
`docker run -p 8080:8080 -e STUNNEL_HOST=portal.fedsfm.ru:8081 -v data:/etc/stunnel --name proxy-gost --rm xxx/xxx:proxy-gost-latest`
...
[За основу взят этот проект](https://github.com/0xssanechka/GOST-stunnel/tree/main)

Работа с Крипто Про и некоторые моменты [отсюда](https://pushorigin.ru/cryptopro/cryptcp?ysclid=m9b7b92aqt193934357)
